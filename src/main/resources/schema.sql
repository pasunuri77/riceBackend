...
ALTER TABLE return_requests ADD COLUMN IF NOT EXISTS received_at timestamp(6);
ALTER TABLE return_requests ADD COLUMN IF NOT EXISTS received_condition varchar(255);
ALTER TABLE return_requests ADD COLUMN IF NOT EXISTS received_note text;
ALTER TABLE return_requests ADD COLUMN IF NOT EXISTS refund_reference varchar(255);
ALTER TABLE return_requests ADD COLUMN IF NOT EXISTS refund_note text;
